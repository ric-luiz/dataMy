    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="small text-muted"><i class="fa fa-clock-o"></i> Quarta-Feira às 19:32 PM</p>
                                        <p>Mensagem...</p>
                                    </div>
                                </div>
                            </a>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Nome do usuário / Empresa <b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-dashboard"></i> Relatório Completo <i class="fa fa-fw fa-caret-down"></i></a>
                    ...
                    <li>
                        <a href="painel.html"><i class="glyphicon glyphicon-usd"></i> Painel de transações</a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Relatório Completo <small>Visão geral da estatística</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Relatório Completo
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Área Gráfica</h3>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right fa-fw"></i> Pizza gráfica</h3>
                            </div>
                            <div class="panel-body">
                            ...
                            <div class="panel-body">
                                <div class="list-group">
                                    <a href="#" class="list-group-item">
                                        ...
                                        <i class="fa fa-fw fa-calendar"></i> Atualização do calendário
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">5 minutos atrás</span>
                                        <i class="fa fa-fw fa-comment"></i> Comentário postado
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">25 minutos atrás</span>
                                    ...
                                    <a href="#" class="list-group-item">
                                        ...
                                        <i class="fa fa-fw fa-user"></i> Um novo usuário foi adicionado
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">3 horas atrás</span>
                                        <i class="fa fa-fw fa-check"></i> Tarefa completa: "Dados extrído com sucesso!"
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">Ontem</span>
                                        <i class="fa fa-fw fa-globe"></i> "Empresa com boa reputação!"
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">2 dias atrás</span>
                                        <i class="fa fa-fw fa-check"></i> Tarefa completa: "Corrigido erro na página de relatórios"
                                    </a>
                                </div>
                                <div class="text-right">
